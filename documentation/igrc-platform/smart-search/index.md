...
You can find [here](./assets/SmartSearch_labels) all available criterias. The structure is following:
...
[SmartSearch_labels.csv](./smart-search/assets/SmartSearch_labels)
